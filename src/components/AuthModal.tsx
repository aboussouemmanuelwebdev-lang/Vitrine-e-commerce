            ...
            {auth.currentUser ? (
              ...
              <>
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center space-x-3 bg-gray-50 dark:bg-white/5 py-4 rounded-2xl text-sm font-bold hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
                >
